---
name: sync-upstream
description: Use when pulling, fetching, comparing, merging, or synchronizing plugin, skill, agent, script, or manifest updates from the upstream microsoft/power-platform-skills repository into this Equinor-aligned fork.
user-invocable: true
