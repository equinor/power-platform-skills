...
If your host does not support these commands, use its plugin marketplace interface. Search for the `equinor/power-platform-skills` marketplace, then install `canvas-apps`.
